...
import {
  CreateVolunteerDto,
  CreateVolunteerResponseDto,
  GetAllVolunteerResponseDto,
  GetVolunteerResponseDto,
  UpdateVolunteerApiDto,
...
export class VolunteersController {
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while creating this volunteer`,
  })
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while getting volunteers`,
  })
  async findAll() {
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while getting this volunteer`,
  })
  ...
  @ApiOkResponse({ type: GetVolunteerResponseDto })
  @ApiInternalServerErrorResponse({
    example: `An error occurred while updating this volunteer`,
  })
  async update(
    @Param('id') id: string,
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while deleting this volunteer record`,
  })
