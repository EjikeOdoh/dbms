...
export class StaffController {
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while creating this staff`,
  })
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while fetching all staff`,
  })
  async findAll() {
  ...
  @ApiOkResponse({ type: CreateStaffResponseDto })
  @ApiInternalServerErrorResponse({
    example: `An error occurred while updating this staff record`,
  })
  async update(
    @Param('id') id: string,
  ...
  @ApiInternalServerErrorResponse({
    example: `An error occurred while deleting this staff record`,
  })
