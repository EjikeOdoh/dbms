...
export class SponsorshipController {
  ...
  @ApiInternalServerErrorResponse({    example: `An unexpected error occurred while getting sponsorships.`  })
  findAll() {
  ...
  @ApiOkResponse({type: GetAllSponsorshipDto})
  @ApiInternalServerErrorResponse({    example: `An unexpected error occurred while getting this sponsorship.`  })
