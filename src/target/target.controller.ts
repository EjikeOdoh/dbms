...
export class TargetController {
  ...
  @ApiInternalServerErrorResponse({
    example: `An unexpected error occurred while creating this target`,
  })
  ...
  @ApiOkResponse({ type: [CreateTargetResponseDto] })
  @ApiInternalServerErrorResponse({
    example: `An unexpected error occurred while getting targets.`,
  })
  async findAll() {
  ...
  @ApiOkResponse({ type: CreateTargetResponseDto })
  @ApiInternalServerErrorResponse({
    example: `An unexpected error occurred while getting this target.`,
  })
  ...
  @ApiOkResponse({ type: CreateTargetResponseDto })
  @ApiInternalServerErrorResponse({
    example: `An unexpected error occurred while updating this target.`,
  })
  ...
  @ApiInternalServerErrorResponse({
    example: `An unexpected error occurred while deleting this target.`,
  })
