...
export class TargetService {
  ...
  async create(createTargetDto: CreateTargetDto) {
    ...
    try {
      ...
      console.log(error)
      throw new InternalServerErrorException('An unexpected error occurred while creating this target.');
    }
  }
  ...
  async findAll() {
    try {
      ...
      console.log(error)
      throw new InternalServerErrorException('An unexpected error occurred while getting targets.');
    }
  }
  ...
  async findOne(id: number) {
    try {
      ...
      console.log(error)
      throw new InternalServerErrorException('An unexpected error occurred while getting this target.');
    }
  }

  async findTargetByYear(year: number): Promise<number> {
    try {
      const { target } = await this.targetRepository.findOne({ where: { year } })
      return target
    } catch (error) {
      console.log(error)
      throw new InternalServerErrorException('An unexpected error occurred while getting this target.');
  ...
  async update(id: number, updateTargetDto: UpdateTargetDto) {
    try {
      ...
      console.log(error)
      throw new InternalServerErrorException('An unexpected error occurred while updating this target.');
    }
  }
  ...
  async remove(id: number) {
    try {
      ...
      console.log(error)
      throw new InternalServerErrorException('An unexpected error occurred while deleting this target.');
    }
  }
}
